...
const ResetPasswordPage: React.FC = () => {
  ...
  const calculateStrength = () => {
    ...
    if (strengthPercentage <= 40) return { value: strengthPercentage, label: "Weak", color: "var(--error-color)" };
    if (strengthPercentage <= 80) return { value: strengthPercentage, label: "Moderate", color: "var(--warning-color)" };
      ...
      <div className="reset-password-box reset-password-card">
        ...
        <form onSubmit={handleSubmit} className="reset-password-form">
          <div className="form-group">
            ...
            {password && (
              <div className="password-strength-container">
                ...
                {strength.label && <span className="strength-text" style={{ color: strength.color }}>{strength.label}</span>}
              </div>
            )}
          ...
          <div className="login-link">
            <Link href="/LoginPage">Return to Login</Link>
          </div>
        </form>
      </div>
    </div>
