...
import faqImage from "@/public/assets/images/faq-illustration.png";
    ...
    <>
      ...
      <div className="faq-page">
        <div className="faq-header">
          <img src={faqImage.src} alt="Frequently Asked Questions illustration with question mark and information symbols" className="faq-image" />
