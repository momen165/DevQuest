      ...
      if (allPassed) {
        ...
        if (badge_awarded) {
          output +=
            ...
            (badge_awarded.badge_type === 'code_novice'
              ? 'Code Novice'
              : badge_awarded.badge_type === 'lesson_smasher'
                ? 'Lesson Smasher'
                : badge_awarded.badge_type === 'language_explorer'
                  ? 'Language Explorer'
                  : badge_awarded.badge_type === 'streak_master'
                    ? 'Streak Master'
                    : badge_awarded.badge_type === 'xp_achiever'
                      ? '100 XP Achieved'
                      : 'New Badge') +
            '!\n';
        }
        ...
        <div className="reset-modal-overlay">
          <div className="reset-modal">
            ...
            <p className="reset-modal-message">
              Are you sure you want to reset your code to the template? This will erase your current
              changes.
            </p>
        ...
        <div className="editor-settings-menu">
          ...
          <div className="settings-group">
            ...
            <div className="font-size-control">
              <button className="font-size-button" onClick={() => adjustFontSize(-1)}>
                -
              </button>
