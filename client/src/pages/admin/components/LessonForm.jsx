...
import { languageMappings } from 'utils/lessonConstants';
  ...
  const validate = () => {
    ...
    for (let i = 0; i < test_cases.length; i++) {
      ...
      if (!testCase.auto_detect && !testCase.use_pattern && !testCase.expected_output.trim()) {
        setError(`Test case ${i + 1}: Expected output is required when not using auto-detect or pattern validation`);
        return false;
      }
    ...
    <div className={`form-container ${isSaving ? 'form-loading' : ''}`}>
      ...
      <form className="lesson-form">
        <div className="form-group">
          <label className="form-label"><FiFileText size={14} /> Lesson Name</label>
          <input
            type="text"
        ...
        <div className="form-group">
          <label className="form-label"><FiBook size={14} /> Lesson Content</label>
        ...
        <div className="form-group">
          <label className="form-label"><FiAward size={14} /> Experience Points (XP)</label>
          <input
            type="number"
            className="form-input"
            value={xp}
        ...
        <div className="form-group">
          <label className="form-label"><FiTerminal size={14} /> Test Cases</label>
          <TestCaseManager
        ...
        <div className="form-group">
          <label className="form-label"><FiCode size={14} /> Starter Template Code</label>
        ...
        <div className="form-group">
          <label className="form-label"><FiHelpCircle size={14} /> Hint</label>
          <div className="editor-container">
            <CustomEditor
              initialData={hint}
              onChange={setHint}
        ...
        <div className="form-group">
          <label className="form-label"><FiCheckCircle size={14} /> Solution</label>
          <div className="editor-container">
            <CustomEditor
