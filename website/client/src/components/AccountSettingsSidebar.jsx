    ...
    <div className="account-settings-sidebar">
      <ul className="account-settings-sidebar-list">
        <Link to="/AccountSettings" className="account-settings-sidebar-link">
          <li className={`account-settings-sidebar-item ${activeLink === 'profile' ? 'account-settings-sidebar-item-active' : ''}`}> 
            <FaUser 
              size={24} 
        ...
        <Link to="/changepassword" className="account-settings-sidebar-link">
          <li className={`account-settings-sidebar-item ${activeLink === 'login' ? 'account-settings-sidebar-item-active' : ''}`}>
            <FaRightToBracket 
              size={24} 
        ...
        <Link to="/billing" className="account-settings-sidebar-link">
          <li className={`account-settings-sidebar-item ${activeLink === 'billing' ? 'account-settings-sidebar-item-active' : ''}`}>
            <FaCreditCard 
              size={24} 
