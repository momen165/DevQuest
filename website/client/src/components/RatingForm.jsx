    ...
    useEffect(() => {
        const checkEligibility = async () => {
            if (!user?.user_id || !courseId) {
                console.log('Missing user or courseId:', { user_id: user?.user_id, courseId });
                return;
            }
                ...
                <div className={`rating-form ${!isVisible ? 'hidden' : ''}`}>
                    ...
                    <div className="feedback-message">
                        {!user?.user_id ? (
                            ...
                            <p>Complete at least 30% of the course to provide feedback. ({courseProgress}% completed)</p>
                        ) : (
                            <p>
                                You've already submitted feedback for this course. 
                                Complete the entire course to provide additional feedback, 
                                or contact us at support@devquest.com for any other thoughts.
                            </p>
                        )}
