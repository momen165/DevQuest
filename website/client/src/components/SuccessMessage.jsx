...
const SuccessMessage = ({ onClose, message = "Success", subText = "Operation completed successfully" }) => {
  return (
    <div className="success-card">
      ...
      <div className="success-message-text-container">
        ...
        <p className="success-sub-text">{subText}</p>
      </div>
      <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 15 15"
