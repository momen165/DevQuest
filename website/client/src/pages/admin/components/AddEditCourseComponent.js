...
const EditCourseForm = ({ course, onClose, onSave, languageOptions }) => {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (course && course.course_id) {
        ...
        await axios.put(`/api/editCourses/${course.course_id}`, formData, {
          headers: {
        ...
        // Add a new course
        await axios.post('/api/addCourses', formData, {
          headers: {
            Authorization: `Bearer ${token}`,
            'Content-Type': 'multipart/form-data',
          },
