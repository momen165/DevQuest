          ...
          <div className={styles.profileContentContainer}>
            ...
            <div className={styles.leftColumn}>
              <div className={styles.profileHeader}>
                <img src={user.profileimage ? user.profileimage : defaultProfilePic} alt="Profile Avatar" className={styles.profileAvatar} />
            ...
            <div className={styles.rightColumn}>
              ...
              {profileData && profileData.courses && profileData.courses.length > 0 ? (
                  profileData.courses.map(course => (
                      <div key={course.id} className={`${styles.courseCard} ${styles.courseCardYellow}`}>
                        <h4>{course.title}</h4>
